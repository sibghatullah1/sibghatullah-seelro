...
\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
\033[1;96m................\033[1;93mSibghatullahseelro\033[1;91m...............
\033[1;96m................\033[1;93m✬🄵🄰🄲🄴🄱🄾🄾🄺✬\033[1;91m..............

\033[1;96m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░

\033[1;91m☞ Auther     : Sibghatullah seelro
\033[1;92m☞ WhatsApp   : 03171343510
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf sibghatullah)
	    os.system('cd $HOME && git clone https://github.com/sibghatullah seelro)
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WellCome To Sibghatullah)
	    psb('Congratulations S4 SibghatullahTool Has Been Updated Successfully')
	    psb('🔓User Name☆ Sibghatullah✓')
	    psb('🔓Password ☆ seelro✓')
	    psb('Subscrib My Youtube Channel B4 BALOCH M4 MASTER✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/sibghatullah && python2 B4.py')
	elif bm =='3':
...
def pb():
	...
	if bp =='':
		...
		print (logo)
		try:
			idlist=raw_input(S + '[☆] ' + R + 'Enter File Path: ' + S + '')
